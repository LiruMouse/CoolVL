...
protected:
	...
	static void	onImportScaleCommit(LLUICtrl* ctrl, void* userdata);
	static void	onPelvisOffsetCommit(LLUICtrl* ctrl, void* userdata);
	static void	onDeformCommit(LLUICtrl* ctrl, void* userdata);
	static void	onUploadJointsCommit(LLUICtrl* ctrl, void* userdata);
	static void	onUploadSkinCommit(LLUICtrl* ctrl, void* userdata);

	static void	onPreviewLODCommit(LLUICtrl* ctrl, void* userdata);

	static void	onGenerateNormalsCommit(LLUICtrl* ctrl, void* userdata);

	static void toggleGenerateNormals(LLUICtrl* ctrl, void* userdata);

	static void	onAutoFillCommit(LLUICtrl* ctrl, void* userdata);
	...
	static void	onExplodeCommit(LLUICtrl* ctrl, void* userdata);
...
private:
	...
	bool mSentFeeRequest;		// true while waiting for a reply to a fee request
	bool mSentUploadRequest;	// true while waiting for the end of an upload
