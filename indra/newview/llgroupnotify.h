...
class LLGroupNotifyBox : public LLPanel, public LLInitClass<LLGroupNotifyBox>
{
public:
	void close();
	...
	static S32 getGroupNotifyBoxCount()		{ return sGroupNotifyBoxCount; }
...
private:
	...
	// This is a LLTimer not a frame timer because I am concerned that I could
	// be out-of-sync by one frame in the animation.
	LLTimer mTimer;
