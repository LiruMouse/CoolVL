...
void LLPrefsVoice::apply()
{
	...
	LLFloaterVoiceDeviceSettings* voice_device_settings;
...
void LLPrefsVoice::onClickVoiceDeviceSettings(void* user_data)
{
	...
	LLFloaterVoiceDeviceSettings* device_settings_floater;
	device_settings_floater = LLFloaterVoiceDeviceSettings::showInstance();
