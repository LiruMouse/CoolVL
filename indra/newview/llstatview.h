...
{
public:
	LLStatView(const std::string& name,
...
*/
	...
	LLStatBar* addStat(const std::string& name,
					   LLStat* statp,
					   const std::string& setting = std::string(),
					   BOOL default_bar = FALSE,
					   BOOL default_history = FALSE);
	LLStatBar* getStatBar(const std::string& name);
	LLStatView* addStatView(const std::string& name,
							const std::string& label,
							const std::string& setting,
							const LLRect& rect);
