...
LLSurface::~LLSurface()
{
	...
	LLDrawPoolTerrain *poolp = (LLDrawPoolTerrain*)gPipeline.findPool(LLDrawPool::POOL_TERRAIN,
																	  mSTexturep);
	if (!poolp)
	{
...
void LLSurface::initTextures()
{
	...
	{
		createWaterTexture();
		mWaterObjp = (LLVOWater*)gObjectList.createObjectViewer(LLViewerObject::LL_VO_WATER,
																mRegionp);
