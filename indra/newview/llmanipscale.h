...
private:
	...
	void			renderAxisHandle(const LLVector3& start,
									 const LLVector3& end);
	...
	inline void		conditionalHighlight(U32 part,
	...
	void			sendUpdates(BOOL send_position_update,
...
private:
	...
	{
		bool operator() (const ManipulatorHandle* const a,
