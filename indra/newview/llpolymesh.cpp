...
U32 LLPolyMeshSharedData::getNumKB()
{
	...
	if (!isLOD())
	{
		num_kb += mNumVertices * (sizeof(LLVector3) +	// coords
...
//			}
		...
		LL_DEBUGS("PolyMesh") << "verts: " << numVertices << ", faces: "
							  << numFaces << ", tris: " << numTris << LL_ENDL;
...
BOOL LLPolySkeletalDistortionInfo::parseXml(LLXmlTreeNode* node)
{
	...
	for (LLXmlTreeNode* bone = skeletalParam->getFirstChild(); bone;
		 bone = skeletalParam->getNextChild())
	{
