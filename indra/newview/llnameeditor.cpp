...
LLNameEditor::LLNameEditor(const std::string& name, const LLRect& rect,
						   ...
						   void (*keystroke_callback)(LLLineEditor*, void*),
						   void (*focus_lost_callback)(LLFocusableElement*, void*),
						   void* userdata,
...
void LLNameEditor::refreshAll(const LLUUID& id, const std::string& fullname,
							  bool is_group)
{
	for (std::set<LLNameEditor*>::iterator
			it = LLNameEditor::sInstances.begin(),
