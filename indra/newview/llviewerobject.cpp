	...
	bool is_new)
{
	 ...
	 */
	LL_DEBUGS("ViewerObject") << "LLViewerObject::saveScript() "
...
{
	LL_DEBUGS("ViewerObject") << "LLViewerObject::moveInventory " << item_id
							  << LL_ENDL;
	LLMessageSystem* msg = gMessageSystem;
...
BOOL LLViewerObject::removeNVPair(const std::string& name)
{
	...
	LL_DEBUGS("ViewerObject") << "LLViewerObject::removeNVPair(): "
							  << name << LL_ENDL;
...
*/
		...
		{
			LL_DEBUGS("ViewerObject") << "removeNVPair - No region for object"
									  << LL_ENDL;
		}
	}
	return FALSE;
