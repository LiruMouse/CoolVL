...
protected:
	LLFloaterGroupInfo(const std::string& name, const std::string& rect_control, const std::string& title, const LLUUID& group_id = LLUUID::null, const std::string& tab_name = std::string());
