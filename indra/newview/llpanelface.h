...
public:
	...
	LLComboBox*		getComboTexGen()		{ return mComboTexGen; }
	LLSpinCtrl*		getTexScaleU()			{ return mTexScaleU; }
	LLSpinCtrl*		getTexScaleV()			{ return mTexScaleV; }
	LLSpinCtrl*		getTexOffsetU()			{ return mTexOffsetU; }
	LLSpinCtrl*		getTexOffsetV()			{ return mTexOffsetV; }
	LLSpinCtrl*		getTexRot()				{ return mTexRot; }
	LLCheckBoxCtrl*	getTexFlipS()			{ return mCheckTexFlipS; }
	LLCheckBoxCtrl*	getTexFlipT()			{ return mCheckTexFlipT; }
