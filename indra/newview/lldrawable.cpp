...
void LLDrawable::setNumFaces(const S32 newFaces, LLFacePool *poolp,
...
void LLDrawable::setNumFacesFast(const S32 newFaces, LLFacePool *poolp,
								 LLViewerTexture *texturep)
{
...
#if 0
	// disabling this code fixes DEV-20105. Leaving in place in case some other
	// bug pops up as a a result.
								 ...
								 BOOL for_select)
{
	...
	// HACK don't draw attachments for avatars that haven't been visible in
	// more than a frame
