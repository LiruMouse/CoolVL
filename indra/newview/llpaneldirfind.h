...
// This class in an abstract base class for all new style search widgets.
// It contains a pointer to a web browser control

class LLPanelDirFind : public LLPanelDirBrowser, public LLViewerMediaObserver
{
public:
...
protected:
	...
	LLCheckBoxCtrl*	mNewSearchCheck;
};
