...
LLResizeBar::LLResizeBar(const std::string& name,
		...
		switch (mSide)
		{
			case LEFT:
				mResizingView->findSnapEdge(scaled_rect.mLeft,
											...
											SNAP_PARENT_AND_SIBLINGS,
											S32_MAX);
				scaled_rect.mLeft = scaled_rect.mRight - llclamp(scaled_rect.getWidth(),
																 mMinSize, mMaxSize);
				break;
			...
			case TOP:
				mResizingView->findSnapEdge(scaled_rect.mTop,
											...
											SNAP_PARENT_AND_SIBLINGS,
											S32_MAX);
				scaled_rect.mTop = scaled_rect.mBottom + llclamp(scaled_rect.getHeight(),
																 mMinSize, mMaxSize);
				break;
			...
			case RIGHT:
				mResizingView->findSnapEdge(scaled_rect.mRight,
											...
											SNAP_PARENT_AND_SIBLINGS,
											S32_MAX);
				scaled_rect.mRight = scaled_rect.mLeft + llclamp(scaled_rect.getWidth(),
																 mMinSize, mMaxSize);
				break;
			...
			case BOTTOM:
				mResizingView->findSnapEdge(scaled_rect.mBottom,
											...
											SNAP_PARENT_AND_SIBLINGS,
											S32_MAX);
				scaled_rect.mBottom = scaled_rect.mTop - llclamp(scaled_rect.getHeight(),
																 mMinSize, mMaxSize);
				break;
		}
