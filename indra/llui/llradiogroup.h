...
{
public:
	LLRadioCtrl(const std::string& name,
				const LLRect& rect,
 ...
 */
class LLRadioGroup : public LLUICtrl, public LLCtrlSelectionInterface
{
public:
	...
	LLRadioGroup(const std::string& name,
				 const LLRect& rect,
	...
	// Another radio group constructor, but this one doesn't rely on needing a
	// control
	LLRadioGroup(const std::string& name,
				 const LLRect& rect,
				 S32 initial_index,
	...
	// Don't use addChild -- it won't set the callback function correctly.
