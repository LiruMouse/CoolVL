...
void LLViewBorder::drawTextures()
{
	...
	//drawTextureTrapezoid(90.f, mBorderWidth, getRect().getHeight(),
	//					 (F32)getRect().getWidth(),0);
	//drawTextureTrapezoid(180.f, mBorderWidth, getRect().getWidth(),
	//					 (F32)getRect().getWidth(), (F32)getRect().getHeight());
	//drawTextureTrapezoid(270.f, mBorderWidth, getRect().getHeight(), 0,
	//					 (F32)getRect().getHeight());
}

void LLViewBorder::drawTextureTrapezoid(F32 degrees, S32 width, S32 length,
