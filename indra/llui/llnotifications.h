...
typedef boost::signals2::signal<bool(const LLSD&), LLStopWhenNotificationHandled>  LLStandardNotificationSignal;
...
namespace LLNotificationComparators
{
	...
	struct orderByUUID : public orderBy<const LLUUID&>
	{
		...
		:	orderBy<const LLUUID&>(&LLNotification::id, direction)
		{
		}
	};
