...
public:
	...
	void			setSliderValue(const std::string& name, F32 v,
	...
	void			setSliderMouseDownCallback(void (*slider_mousedown_callback)(LLUICtrl*, void*));
	void			setSliderMouseUpCallback(void (*slider_mouseup_callback)(LLUICtrl*, void*));
	...
	static void		onEditorGainFocus(LLFocusableElement* caller,
									  void* userdata);
