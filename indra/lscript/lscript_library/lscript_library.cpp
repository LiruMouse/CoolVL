...
void LLScriptLibrary::init()
{
	...
	// Server RC Magnum v12.01.14.247742 new function:
    ...
    // These functions pertain to OpenSimulator and Aurora-Simulator & are in
	// no part applicable to SecondLife by Linden Labs.
    // The Current State of these functions are in flux and development is
	// ongoing. Not all the functions are presently fully documented and
	// therefore the description may be incomplete and require further
	// attention.
    // OpenSim & Aurora-Sim being written in C# and not C++, some types
	// conversions are different (for example "double = float" etc).
    //
    // OSSL corrections and syntax additions added + set in same order as found
	// in IOSSL_Api.cs of Aurora-Sim & OpenSim Source.
