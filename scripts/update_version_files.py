...
re_map['indra/newview/Info-CoolVLViewer.plist'] = \
...
re_map['indra/newview/English.lproj/InfoPlist.strings'] = \
    (('CFBundleShortVersionString = "Cool VL Viewer version [0-9.]+";',
      'CFBundleShortVersionString = "Cool VL Viewer version %(VER_MAJOR)s.%(VER_MINOR)s.%(VER_PATCH)s.%(VER_BUILD)s";'),
     ('CFBundleGetInfoString = "Cool VL Viewer version [0-9.]+',
      'CFBundleGetInfoString = "Cool VL Viewer version %(VER_MAJOR)s.%(VER_MINOR)s.%(VER_PATCH)s.%(VER_BUILD)s'))
